...
/* Motion design du hero, partie haute : 8 traits qui convergent vers le centre,
   du rayon 190 au rayon 56 (angles repartis tous les 42 degres). [x1,y1] = point
   exterieur, [x2,y2] = point interieur ; le trait se dessine vers le centre. */
const INV_ART_FLOWS = (() => {
...
/* Motion design du hero, partie basse : le motif des crochets du logo, avec un
   mot du vocabulaire sport / investissement qui s'ecrit au milieu, puis s'efface.
      ...
      <header className="inv-hero">
        ...
        <div className="inv-wrap inv-hero__main">
          <div className="inv-hero__brand inv-rv">
            {/* ?v=7 : le png est servi en cache immuable (vercel.json), incrementer si le fichier change */}
          ...
          {/* Motion design du hero (aout 2026), deux etages : au-dessus les flux de
              capital qui convergent vers un point unique (la room), en dessous les
              crochets du logo autour d'un mot qui s'ecrit. Decoratif, aria-hidden. */}
          <div className="inv-hero__art" aria-hidden="true">
            <svg className="inv-art__orb" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg">
              <defs>
